 ...
 *
 * It is not up to the [KoordinatorRoute] to decide where or how to navigate! Do not couple view flows to a
 ...
 *
 * Each screen should have one [KoordinatorRoute] object (this could be an enum or a sealed class).
 */
interface KoordinatorRoute